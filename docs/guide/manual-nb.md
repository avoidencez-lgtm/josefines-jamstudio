...
Trykk Record øverst under avspilling for å ta opp gitar-DI og stereoreferansen. Lagre opptaket før du søker, endrer loop eller bytter kilde. Referansen ligger i band-WAV; genererte tromme-, bass- og kompstemmer er stille, og det finnes ingen genererte MIDI-noter. I musikkprogrammet slår du på band-referansesporet for å høre bakgrunnssangen og lar master være dempet. Tempokartet er ikke en analysert tidslinje for referansen. Fysisk gitarjustering bruker fortsatt manuelt latensavvik. Posisjon og kontroller følger avspillingskøen og kan ligge foran hørbar lyd med den bufrede varigheten.
