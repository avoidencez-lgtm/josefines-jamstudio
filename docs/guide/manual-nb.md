...
Mikrofonlyden holdes i Rust-minnet og sendes bare for talegjenkjenning; den lagres ikke som et opptak. Transkripsjon og svar vises i samtalen. Bandet dempes gradvis over 150 ms; gitarlytting er uendret. Tale og demping skrives ikke til tørr gitar eller separate bandspor. Nettleserforhåndsvisning har ingen mikrofon eller taleavspilling. Verktøylinjen beholder Talk og Cancel på tvers av rom. Stage viser siste runde og har Type a command for tekstkommandoer. Conversation & voice setup åpner Jo AI; låtforslag venter fortsatt der på gjennomgang.

Voice setup har også en global hurtigtast, med CommandOrControl+Shift+J som standard. Save voice setup husker kombinasjonen; Enable shortcut for this session registrerer den til du deaktiverer den eller avslutter appen. Hold og slipp den også når en annen app allerede har fokus. Ta med Control, Command eller Alt; velg en annen kombinasjon hvis den er opptatt. Ingen hurtigtast registreres automatisk ved oppstart.

Lær Talk / send to Jo i Write → Hands-free controls, og aktiver pedalhandlinger. Program Change har ikke slipp-signal: trykk én gang for opptak, igjen for å sende; et trykk under transkripsjon/tenking avbryter. CC-/notepedaler bruker samme to-trykksatferd. Deaktivering eller ny tilkobling av pedalkontroll avbryter opptak. Leverandørens tid til første lyd og en fysisk test med hodesett/pedal er ennå ikke verifisert.

Taleforbruk viser innsendte STT-sekunder og TTS-tegn, også for mislykkede eller avbrutte forespørsler, samt et samlet prisanslag og antall forespørsler uten kjent pris. I Jo AI → Voice setup angir du USD per time for Scribe v2 og USD per 1 000 tegn for Flash v2.5, og trykker Save voice setup. Tomt betyr ukjent; null er et uttrykkelig nullanslag. Ingen priser antas. Hver forespørsel beholder sitt opprinnelige anslag når prisene endres. Inkludert forbruk, avgifter, stemmespesifikke tillegg og leverandørens sluttfaktura beregnes ikke. Eldre loggposter kan fortsatt leses, men manglende taleenheter kan ikke gjenskapes.
...
I skrivebordsappen lagres en vellykket analyse sammen med opptaket og vises igjen når du åpner Sessions, også hvis SQLite-indeksen bygges opp på nytt. Det lagrede øyeblikksbildet inneholder tidspunkt, analyseversjon, samplingsfrekvens, antall sampler og tempo. En skadet analyse eller en ukjent versjon skjuler ikke opptaket: bruk Analyze again. Ved lagringsfeil beholdes det tidligere manifestet, og en feil vises. Målingene oppdateres ikke automatisk hvis du bytter ut lydfilen; åpne Evidence & exercise og bruk Analyze again. Nettleserforhåndsvisningen simulerer bare arbeidsflyten og skriver ingen filer.
...
Opptaket kobler gitarinngangen til bandrammene som sendes til lydutgangen. Save take venter kort på lyd som allerede ligger i kø før filene lukkes. Hvis lydstrømmen eller opptakskøen mister rammer, lagrer du det delvise opptaket og løser det meldte problemet før du tar opp igjen. Guitar offset kompenserer for forsinkelsen målt gjennom opptakets inngangskø. I Sessions åpner du Measure guitar offset. Stopp avspilling, Jo-tale og forhåndslytting, slå av testtonen og programvaremonitorering, og koble en linjeutgang til valgt inngang med egnet kabel. Koble forbi effekter, deaktiver maskinvarens direkte monitorering på denne inngangen, og bruk lavt utgangsnivå; koble aldri til en høyttalerutgang. Play three quiet clicks måler opptil 400 ms forsinkelse. Tre gjenkjente klikk må samsvare innen to samples; et stabilt resultat lagres for faktisk enhetspar, inngangskanal, samplingsfrekvens og buffer. Manglende, klippet eller ustabil retur gir et estimat uten å erstatte lagret justering; tapte rammer eller enhetsfeil avviser målingen. Estimatet bruker to konfigurerte buffere fordi nominell enhetsforsinkelse ikke er tilgjengelig. Use this estimate as manual offset er et uttrykkelig valg. Koble fra sløyfekabelen før du spiller. Du kan fortsatt skrive inn en DAW-målt Guitar offset manuelt. Ulike enhetskonfigurasjoner har separate verdier; en ny konfigurasjon starter på null etter at profiler er lagret. Eldre globale verdier beholdes til første profil lagres. Syntetiske tester kontrollerer algoritmen og opptaksjusteringen, ikke den fysiske riggen din. Nye fulle opptak inneholder separat gitar, trommer, bass og komp, band-/masterreferanser, planlagte bandnoter i MIDI, tempokart og øyeblikksbilde av fremføringen. Refererte gitarlag eksporteres som justerte WAV-filer. Fangede enkeltideer rekonstruerer ikke band-MIDI. Manglende filer rapporteres i eksportresultatet.
