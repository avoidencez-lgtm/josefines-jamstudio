...
8. In Rig, select a MIDI port explicitly and verify scene mappings with the real
   hardware before using section automation.

Save documents before closing the app. See the [room guide](guide/studio-rooms.md)
for each workflow, [media guide](guide/music-video.md) for model setup and
[owner checks](plan/06-owner-verification.md) for the Mac/rig acceptance checklist.
