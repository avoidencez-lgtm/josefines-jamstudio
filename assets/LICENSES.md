...
## Test fixture chords-c-f-g-90 (not bundled)

- **License**: CC0-1.0
- **Source**: original synthetic C/F/G triad loop at 90 BPM, generated by
  `crates/jam-audio/src/import.rs` into `tests/fixtures/audio/chords-c-f-g-90.wav`
  during `jam-audio` tests. The WAV is gitignored.
- **Attribution**: Josefines Jamstudio. Not a recorded song or provider result.
