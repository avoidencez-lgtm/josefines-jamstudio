        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2" title="Band volume">
            ...
            <input
              ...
              step={0.05}
              value={bandVolume}
              onChange={(e) => setBandVolume(Number.parseFloat(e.target.value))}
      ...
      <Panel className="py-2 px-3">
        <div className="flex items-center justify-between px-1">
          ...
          <div className="text-[10px] font-mono text-[var(--fg-2)]">
            click a bar to jump · shift-click to set the loop · 1–9 jump to bar
          </div>
        </div>
        <ChordStrip
          chart={currentChart}
        ...
        <Panel className="flex flex-col items-center justify-center min-h-[260px]">
          {isCountingIn ? (
            ...
            <BigReadout
              ...
              label={
                band.is_stopped ? "Band stopped (S to resume)" : "Active Chord"
              }
      ...
      <Panel title="Tempo Trainer">
        <div className="flex flex-wrap items-center gap-4">
          <Toggle
            ...
            onChange={(enabled) => setTempoTrainer({ enabled, lastStepBar: 0 })}
          ...
          <span className="text-[10px] font-mono text-[var(--fg-2)] max-w-xs">
            Press play: the band starts at the start tempo and creeps toward the
            target. Loop a hard passage (shift-click two bars) to drill it.
          </span>
        </div>
      </Panel>
