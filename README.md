...
| Songs / real songs (M3) | Partial | Local audio import, reference playback, pitch-preserving speed/transpose practice copies and Film soundtrack selection. Stems, automatic beats/chords and native reference transport remain unbuilt. |
